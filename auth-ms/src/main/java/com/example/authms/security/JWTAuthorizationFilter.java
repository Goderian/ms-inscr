...
/**
 * Authorization filter is the first executed filter on every incoming request,
 * doFilterInternal is executed so to add different needed headers to the response
 * as well as different filtering and verification operations on the jwt
 * */
...
//        response.addHeader("Access-Control-Allow-Origin", "*");
        ...
        * */
             ...
             * and extraction of different information
             * of the user (username, roles, ...)
             * */
